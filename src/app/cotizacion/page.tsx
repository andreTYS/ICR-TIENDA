          ...
          {enviado ? (
            ...
            <form onSubmit={onSubmit}>
              ...
              <div className="flex flex-col gap-3.5">
                ...
                {error && (
                  <div className="text-[11.5px] text-red-600 bg-red-50 border border-red-200 px-3 py-2.5 leading-relaxed">
                    {error}
                  </div>
                )}
                <button
                  type="submit"
                  disabled={enviando}
                  className="border-0 bg-accent text-ink font-heading text-xs font-black tracking-[.1em] uppercase px-4 py-4 mt-1 hover:bg-accent-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
