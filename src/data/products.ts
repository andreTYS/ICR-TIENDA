...
export interface Producto {
  ...
  masVendido?: boolean
  vendidos?: number
  /** URL de la foto real del producto (ERP) — sin ella se muestra el placeholder. */
  imagen?: string | null
  /** true si el ERP todavía no tiene un precio de lista cargado para este producto. */
  precioIndefinido?: boolean
}
